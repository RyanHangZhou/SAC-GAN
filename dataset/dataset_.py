...
class CityscapesDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # if self.is_train:
        #     return theta_gt, theta_gt_ref, background_image, layout, cond_layout, norm_mask, norm_obj, object_edge, sample
        # else:
        #     return background_image, layout, patch_mask, patch_obj, norm_mask, object_edge, sample
        return target
